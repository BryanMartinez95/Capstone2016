...
/**
 * Implementation of IPaginatedList backed by an ArrayList
 */
public class PaginatedArrayList implements IPaginatedList
{
	...
	public PaginatedArrayList(Collection c, int pageSize)
	{
		...
		this.totalPages = this.list.size() / pageSize + 1;
		repaginate();
	}
