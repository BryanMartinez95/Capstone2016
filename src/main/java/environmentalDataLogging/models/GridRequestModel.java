...
public class GridRequestModel
{
    ...
    public GridRequestModel(int pageSize, int currentPage, List<FilterModel> filters, String sortColumn, SortType ascending, List<String> ignoredColumns, Status gridStatus)
    {
