...
public class MvcConfig extends WebMvcConfigurerAdapter
{
	...
	public void addViewControllers(ViewControllerRegistry registry)
	{
		...
		registry.addViewController("/Device/Edit").setViewName("main");
		registry.addViewController("/Client").setViewName("main");
		registry.addViewController("/Client/Edit").setViewName("main");
		registry.addViewController("/Client/Add").setViewName("main");
