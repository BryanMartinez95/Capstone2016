 ...
 */
angular.module('appService').factory('GridService',
    ['Enum', 'GridRequestModel', '$filter', 'ExportService', 'SingleSelect',
        function (Enum, GridRequestModel, $filter, ExportService, SingleSelect) {
